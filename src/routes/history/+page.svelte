...
<div class="px-4 py-4 sm:px-5 sm:py-5">
  <div class="mx-auto flex max-w-[1440px] flex-col gap-5">
    <section class="rounded-lg border border-[var(--border)] bg-[var(--panel)] px-4 py-4 sm:px-5">
      <h1 class="text-base font-medium tracking-[-0.02em] text-[var(--text-primary)] mb-4">History</h1>
      ...
      {#each sections as section}
        <section class="rounded-lg border border-[var(--border)] bg-[var(--panel)] px-4 py-4">
          <div class="border-b border-[var(--border)] pb-3">
            <div class="text-sm font-medium tracking-[-0.02em] text-[var(--text-primary)]">{section.label}</div>
          </div>
